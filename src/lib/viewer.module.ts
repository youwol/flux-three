...
export namespace ModuleViewer {
    ...
    let defaultLightsFunction = `
return ({AmbientLight, HemisphereLight, DirectionalLight, PointLight, SpotLight, RectAreaLight}) => {
    let light = new HemisphereLight("#ffffff",  "#000000", 0.7 )
...
`
    ...
    export class PersistentData {
         ...
         */
        @Property({
            description: "default lights",
            type: "code",
        })
        readonly lighting: string | LightingFunction = defaultLightsFunction

        getLights(): Light[] {

            let args = { AmbientLight, HemisphereLight, DirectionalLight, PointLight, SpotLight, RectAreaLight }
            if (typeof this.lighting == 'string')
                return new Function(this.lighting)()(args)

            return this.lighting(args)
        }
    ...
    */
    ...
    export class Module extends ModuleFlux {
        ...
        init(renderingDiv: HTMLDivElement, camera?: PerspectiveCamera) {
            ...
            let lights = createDefaultLights(config.getLights())
